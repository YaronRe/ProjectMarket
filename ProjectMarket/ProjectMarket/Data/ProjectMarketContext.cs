    ...
    public class ProjectMarketContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Sale>().HasData(
                ...
                new Sale() { Id = 2,  ProjectId = 4, BuyerId = 1, Price = 0.0, AcademicInstituteId = null, Rank = null, Grade = null },
                new Sale() { Id = 3,  ProjectId = 6, BuyerId = 1, Price = 0.0, AcademicInstituteId = 1, Rank = 2, Grade = 70 },
                
                new Sale() { Id = 5,  ProjectId = 3, BuyerId = 3, Price = 0.0, AcademicInstituteId = null, Rank = null, Grade = null },
                new Sale() { Id = 6,  ProjectId = 5, BuyerId = 3, Price = 0.0, AcademicInstituteId = null, Rank = null, Grade = null },
                new Sale() { Id = 4,  ProjectId = 6, BuyerId = 3, Price = 0.0, AcademicInstituteId = null, Rank = null, Grade = null },
                new Sale() { Id = 7,  ProjectId = 7, BuyerId = 3, Price = 0.0, AcademicInstituteId = 1, Rank = 4, Grade = 80 },
                new Sale() { Id = 8,  ProjectId = 8, BuyerId = 3, Price = 0.0, AcademicInstituteId = null, Rank = null, Grade = null },
                
                new Sale() { Id = 10, ProjectId = 3, BuyerId = 5, Price = 0.0, AcademicInstituteId = 2, Rank = 3, Grade = 70 },
                new Sale() { Id = 11, ProjectId = 5, BuyerId = 5, Price = 0.0, AcademicInstituteId = 2, Rank = 3, Grade = 70 },
                new Sale() { Id = 9, ProjectId = 6, BuyerId = 5, Price = 0.0, AcademicInstituteId = 2, Rank = 3, Grade = 70 },
                
                new Sale() { Id = 12, ProjectId = 3, BuyerId = 6, Price = 0.0, AcademicInstituteId = 2, Rank = 3, Grade = 70 },
                new Sale() { Id = 13, ProjectId = 5, BuyerId = 6, Price = 0.0, AcademicInstituteId = 2, Rank = 3, Grade = 70 },
                new Sale() { Id = 14, ProjectId = 6, BuyerId = 6, Price = 0.0, AcademicInstituteId = 2, Rank = 3, Grade = 70 }
                );
